...
export const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    skills: [
      { name: 'Node.js',  logo: '/assets/logos/nodejs.png',   level: 85 },
      { name: 'Express',  logo: '/assets/logos/express.svg',  level: 82 },
      { name: 'Django',   logo: '/assets/logos/django.png',   level: 78 },
      { name: 'Laravel',  logo: '/assets/logos/laravel.png',  level: 80 },
  ...
  },
  {
    ...
    skills: [
      { name: 'MySQL',     logo: '/assets/logos/mysql.jpg',     level: 88 },
  ...
  },
  {
    ...
    skills: [
      { name: 'JavaScript', logo: '/assets/logos/javascript.png', level: 90 },
      { name: 'Python',     logo: '/assets/logos/python.png',     level: 88 },
      { name: 'Java',       logo: '/assets/logos/java.png',       level: 82 },
      { name: 'PHP',        logo: '/assets/logos/php.svg',        level: 82 },
...
export const CERTIFICATES = [
...

  {
    ...
    orgLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/8d/HKUST_logo.svg/200px-HKUST_logo.svg.png',
    platform: 'Coursera',
    platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
    certImage: '/assets/certificates/software-eng-hkust.png',
    year: '2024',
    verify: '',
  },
  {
    ...
    platform: 'Coursera',
    platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
    certImage: '/assets/certificates/react-basics-meta.png',
    year: '2024',
    verify: '',
  },
  {
    ...
    orgLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/3/32/Johns_Hopkins_University_seal.svg/200px-Johns_Hopkins_University_seal.svg.png',
    platform: 'Coursera',
    platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
    certImage: '/assets/certificates/unix-workbench-jhu.png',
    year: '2024',
    verify: '',
  },
  {
    ...
    orgLogo: 'https://upload.wikimedia.org/wikipedia/fr/thumb/2/22/Logo_Ecole_Polytechnique.svg/200px-Logo_Ecole_Polytechnique.svg.png',
    platform: 'Coursera',
    platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
    certImage: '/assets/certificates/recherche-doc-polytechnique.png',
    year: '2024',
    verify: '',
  }
  // {
  ...
  //   org: 'Google',
  //   orgLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/200px-Google_2015_logo.svg.png',
  //   platform: 'Coursera',
  //   platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
  //   certImage: '/assets/certificates/agile-pm-google.png',
  //   year: '2024',
  //   verify: '',
  // },
  // {
  ...
  //   orgLogo: 'https://upload.wikimedia.org/wikipedia/en/thumb/0/01/UC_San_Diego_logo.svg/200px-UC_San_Diego_logo.svg.png',
  //   platform: 'Coursera',
  //   platformLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Coursera-Logo_600x600.svg/120px-Coursera-Logo_600x600.svg.png',
  //   certImage: '/assets/certificates/big-data-ucsd.png',
  //   year: '2024',
  //   verify: '',
  // },
]
